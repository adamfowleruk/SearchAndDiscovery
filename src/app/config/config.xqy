...
declare variable $c:ROXY-ROUTES :=
  <routes xmlns="http://marklogic.com/appservices/rest">
	    ...
	    <request uri="^/show/view(.*)" endpoint="/app/views/show/view.html.xqy"/>
...
declare variable $c:SEARCH-OPTIONS :=
  ...
  <constraint name="title">
    <range type="xs:string" collation="http://marklogic.com/collation/" facet="true">
      <element ns="http://www.w3.org/1999/xhtml" name="title"/>
     <facet-option>limit=5</facet-option>
  ...
  <constraint name="Subject">
    <range type="xs:string" facet="true">
     <path-index xmlns:xhtml="http://www.w3.org/1999/xhtml">/xhtml:html/xhtml:head/xhtml:meta[@name = "Subject"]/@content</path-index>
     <facet-option>limit=5</facet-option>
     <facet-option>frequency-order</facet-option>
     <facet-option>descending</facet-option>
    </range>
  ...
  <constraint name="Terms">
    <range type="xs:string" collation="http://marklogic.com/collation/" facet="true">
      <element ns="" name="potential"/>
  ...
  <constraint name="Author">
    <range type="xs:string" facet="true">
     <path-index xmlns:xhtml="http://www.w3.org/1999/xhtml">/xhtml:html/xhtml:head/xhtml:meta[@name = "Author"]/@content</path-index>
     <facet-option>limit=5</facet-option>
     <facet-option>frequency-order</facet-option>
     <facet-option>descending</facet-option>
    </range>
  ...
  <constraint name="Company">
    <range type="xs:string" facet="true">
     <path-index xmlns:xhtml="http://www.w3.org/1999/xhtml">/xhtml:html/xhtml:head/xhtml:meta[@name = "Company"]/@content</path-index>
     <facet-option>limit=5</facet-option>
     <facet-option>frequency-order</facet-option>
     <facet-option>descending</facet-option>
    </range>
  ...
  <constraint name="Producer">
    <range type="xs:string" facet="true">
     <path-index xmlns:xhtml="http://www.w3.org/1999/xhtml">/xhtml:html/xhtml:head/xhtml:meta[@name = "Producer"]/@content</path-index>
     <facet-option>limit=5</facet-option>
     <facet-option>frequency-order</facet-option>
     <facet-option>descending</facet-option>
    </range>
  ...
  <constraint name="content-type">
    <range type="xs:string" facet="true">
     <path-index xmlns:xhtml="http://www.w3.org/1999/xhtml">/xhtml:html/xhtml:head/xhtml:meta[@name = "content-type"]/@content</path-index>
     <facet-option>limit=15</facet-option>
     <facet-option>frequency-order</facet-option>
     <facet-option>descending</facet-option>
    </range>
