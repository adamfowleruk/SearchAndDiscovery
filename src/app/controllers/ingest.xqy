...
module namespace c = "http://marklogic.com/roxy/controller/ingest";
...
declare function c:ticketinfo() as item()*
{
  ()
(:
  ch:add-value("message", "This is a test message."),
...
declare function c:ticketerrors() as item()*
{
  ()
(:
  ch:add-value("message", "This is a test message."),
